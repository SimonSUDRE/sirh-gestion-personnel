...
<%@ include file="../includeNav.jsp" %>
	...
	<section>
		<article>
			<div class="container">
				<a href='<c:url value="/collaborateurs/creer"></c:url>' class="btn btn-primary btn-default mt-2 mt-sm-0 col-sm-12 col-md-5 col-lg-4 offset-lg-9 offset-md-9">Ajouter un nouveau collaborateur</a>
			</div>
		</article>
		<article>
			<div class="container">
		...
		<article>
			<div class="container taille">
				<form action='<c:url value="/collaborateurs/lister"></c:url>' method="post" class="form-inline">
					...
					<div class="collab col-md-6 col-lg-6 col-sm-12">
						<div class="card">
							...
							<div class="card-body row">
								<div class="card-text">
									<img src='<c:url value="${collab.photo}"/>' class="img-thumbnail col-lg-4 col-md-2 col-sm-2" />
									<div class="col-lg-10 col-md-10 col-sm-8 row">
										<span class="col-lg-6 col-md-6 col-sm-6">Fonction : </span>
										<span class="col-lg-6 col-md-6 col-sm-6">${ collab.intitulePoste }</span>
										<span class="col-lg-6 col-md-6 col-sm-6">Département : </span>
										<span class="col-lg-6 col-md-6 col-sm-6">${ collab.departement.nom }</span>
										<span class="col-lg-6 col-md-6 col-sm-6">Email : </span>
										<span class="col-lg-6 col-md-6 col-sm-6">${ collab.emailPro }</span>
										<span class="col-lg-6 col-md-6 col-sm-6">Téléphone : </span>
										<span class="col-lg-6 col-md-6 col-sm-6">${ collab.telephone }</span>
									</div>
								</div>
								<div class="col-lg-12 col-sm-12 col-md-12"><br></div>
								<form method="post" action='<c:url value="/collaborateurs/editer"/>'>
