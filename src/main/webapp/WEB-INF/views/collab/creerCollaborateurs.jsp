	...
	<section>
		<article>
			...
			<div class="container offset-lg-2">
				<form class="needs-validation" action="<%= request.getContextPath() %>/collaborateurs/creer" method="post" >
					...
					<div class="form-row form">
						...
						<input type="number" class="form-control mr-sm-2 mb-2 mb-sm-0 col-lg-6" id="nss" name="nss" min="100000000000000" max="999999999999999" title="15 chiffres" required>
						<div class="invalid-feedback offset-3">
							Le numéro de sécurité social est obligatoire
						</div>
					</div>
					<div class="form-row form">
						<button type="submit" id="creer" name="creer" class="btn btn-default mt-2 mt-sm-0 offset-8 col-lg-1" >Créer</button>
					</div>
				</form>
